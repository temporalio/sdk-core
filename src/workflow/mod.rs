...
pub struct OutgoingServerCommands {
    ...
    pub local_activities_to_execute: Vec<ScheduleActivity>,
    pub replaying: bool,
}
...
impl WorkflowManager {
    ...
    pub fn get_server_commands(&mut self) -> OutgoingServerCommands {
        // TODO: Renames if this place ends up being a fine place to do this
        let local_activities_to_execute = self.machines.drain_queued_local_activities();

        OutgoingServerCommands {
            commands: self.machines.get_commands(),
            replaying: self.machines.replaying,
            local_activities_to_execute,
        }
    }
