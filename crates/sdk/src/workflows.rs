...
#[doc(hidden)]
pub trait WorkflowImplementation: WorkflowDefinition + Sized + 'static {
    ...
    fn init(ctx: WorkflowContextView, input: Option<<Self as WorkflowDefinition>::Input>) -> Self;
    ...
    fn run(
        ...
        input: Option<<Self as WorkflowDefinition>::Input>,
    ...
    <W as WorkflowDefinition>::Input: Send,
{
    ...
    pub(crate) fn new(
        ...
        init_input: Option<<W as WorkflowDefinition>::Input>,
        run_input: Option<<W as WorkflowDefinition>::Input>,
    ) -> Self {
        ...
        F: Fn() -> W + Send + Sync + 'static,
    {
        ...
        let factory: WorkflowExecutionFactory =
            Arc::new(move |payloads, converter: PayloadConverter, base_ctx| {
                ...
                let input: <W as WorkflowDefinition>::Input =
